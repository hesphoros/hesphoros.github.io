...
export default {
  ...
  data(){
    return {
      ...
      tipoffsetX:0,
      show_lock_tip:false,
      input_src:"https://blog.csdn.net/m0_72703340",
      real_src:'https://blog.csdn.net/m0_72703340',
      no_http:false,
      href_stack:['https://blog.csdn.net/m0_72703340',],
  ...
  methods:{
    ...
    inputSubmit(){
      ...
      if (googlepat.test(this.input_src)) {
        this.input_src = 'https://blog.csdn.net/m0_72703340'
        noheader = false
      }
      if (noheader) {
